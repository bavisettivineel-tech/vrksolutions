...
const ContactSupport = () => {
  ...
  return (
    <>
      {/* Support buttons - positioned top right */}
      <div className="fixed right-4 top-20 md:top-24 z-50 flex flex-col gap-2">
        <Button
          onClick={handleCall}
          className="rounded-full h-10 w-10 shadow-float gradient-primary p-0"
          title="Call Support"
        >
        ...
        <Button
          ...
          variant="secondary"
          className="rounded-full h-10 w-10 shadow-card p-0"
          title="Chat Support"
        >
